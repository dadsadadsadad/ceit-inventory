...
export default async function MaintenancePage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div className="page maintenance-page"><div className="page-inner space-y-6">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="eyebrow">Maintenance</p><h1 className="title mt-3 text-3xl sm:text-4xl">Maintenance requests</h1><p className="muted mt-2 max-w-2xl text-sm leading-6">Report and resolve repairs without losing the equipment&apos;s inventory history.</p></div><Link href="/dashboard/inventory" className="card card-link rounded-lg px-4 py-2.5 text-center text-sm font-semibold">View inventory</Link></header>
