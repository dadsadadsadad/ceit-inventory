      ...
      <div className="page-inner space-y-6">
        ...
        {canManageSetup && setup ? (
          ...
          <section className="notice rounded-lg px-5 py-4 text-sm leading-6">
            {/* Setup guidance for staff accounts. */}
            <h2 className="font-semibold">Inventory setup</h2>
            <p className="mt-1">
              Only administrators can manage inventory locations and categories. You can update your
              own account details above.
            </p>
          </section>
        )}
      </div>
